...
"  
"  USAGE:
"  <F3>		Turn on highlighting for all lines with markers on them
"  <F4>		Turn off the highlighting for marked lines
"  <SHIFT-F4>	Erase all markers [a-z]
"  <F6>		Add a mark on the current line (and highlight)
"  <SHIFT-F6>	Remove the mark on the current line
"
...
nmap <silent> <F3> :call HLMarks("Marks")<CR>
nmap <silent> <F4> :call clearmatches()<CR>
nmap <silent> <S-F3> :call clearmatches()\|:delmarks a-z<CR>
nmap <F6> :call AddHLMark("Marks")<CR>
nmap <silent> <S-F6> :call DelHLMark("Marks")<CR>
